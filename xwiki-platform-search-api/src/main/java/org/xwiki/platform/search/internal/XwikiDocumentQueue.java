...
public class XwikiDocumentQueue
{
     ...
     */
    private Map<String, AbstractDocument> documentsByName = new HashMap<String, AbstractDocument>();
     ...
     */
    public synchronized AbstractDocument remove() throws BufferUnderflowException
    {
    ...
    public synchronized void add(AbstractDocument data)
    {
